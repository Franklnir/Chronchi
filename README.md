...
Scan QR Code Barcode di bawah ini menggunakan kamera ponsel atau aplikasi pemindai QR untuk langsung mengunduh file APK versi terbaru (`Xichi-v1.4.2-debug.apk`):

<p align="center">
  <img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&margin=10&ecc=M&data=https%3A%2F%2Fgithub.com%2FFranklnir%2FChronchi%2Freleases%2Fdownload%2Fv1.4.2%2FXichi-v1.4.2-debug.apk" alt="QR Code Barcode Download Xichi APK" width="260" height="260" />
</p>

### 🔗 Link Unduhan APK:
- 🚀 **[Klik di Sini untuk Mengunduh Langsung APK v1.4.2](https://github.com/Franklnir/Chronchi/releases/download/v1.4.2/Xichi-v1.4.2-debug.apk)** *(Ukuran file: ~44.3 MB)*
- 🌐 **[Mirror Unduh Versi Rilis Terbaru (GitHub Latest)](https://github.com/Franklnir/Chronchi/releases/latest/download/Xichi-v1.4.2-debug.apk)**
